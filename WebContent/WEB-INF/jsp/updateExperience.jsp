							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="https://maguangjie.com/updateExperience"
											...
											<div class="two fields">
												...
												<div class="field">
													<label>content</label> <input placeholder="content"
														value="${c.content }" name="content" type="text">
												</div>
											</div>
											<div class="field">
												<label>messageId</label>
												<div class="ui selection dropdown" tabindex="0">
													<input value="${c.messageId }" name="messageId"
														type="hidden">
													<div class="default text">${c.messageId}</div>
													<i class="dropdown icon"></i>
													<div class="menu" tabindex="-1">
														<c:forEach items="${mess}" var="m">
															<div class="item" data-value="${m.id }">${m.id }</div>
														</c:forEach>
