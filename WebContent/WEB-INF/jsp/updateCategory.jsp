...
<link href="../css/main.css?A=3" rel="stylesheet" />
						...
						<div class="sixteen wide column">
							<div class="ui segments">
								<div class="ui segment">
									<h5 class="ui header">修改</h5>
								</div>
								<div class="ui segment">

									<div class="row">

										<form action="https://maguangjie.com/updateCategory"
											method="post" class="ui form segment "
											enctype="multipart/form-data">
											<div class="two fields">
												<input value="${c.id }" name="id" type="hidden">
												<div class="field">
													<label>Name</label> <input value="${c.name }"
														placeholder="Name" name="name" type="text">
												</div>
												<div class="field">
													<label>desc_name</label> <input placeholder="desc"
														value="${c.desc_name }" name="desc_name" type="text">
												</div>
											</div>
											<div class="inline fields">
												<label for="fruit">是否修改img：</label>
												<div class="field">
													<div class="ui radio checkbox">
														<input type="radio" value="cimg" name="booleanImg"
															tabindex="0" class="hidden"> <label>cimg</label>
													</div>
												</div>
												<div class="field">
													<div class="ui radio checkbox">
														<input type="radio" value="mimg" name="booleanImg"
															tabindex="0" class="hidden"> <label>mimg</label>
													</div>
												</div>
												<div class="field">
													<div class="ui radio checkbox">
														<input type="radio" value="no" name="booleanImg"
															tabindex="0" class="hidden"> <label>no</label>
													</div>
												</div>
											</div>
											<div class="field">
												<label>cimg</label> <input name="file_cimg" accept="image/*"
													type="file">
											</div>
											<div class="field">
												<label>mimg</label> <input name="file_mimg" accept="image/*"
													type="file">
											</div>
											<div class="field">
												<label>cimgName</label> <input value="${c.cimg }"
													name="cimg" type="text">
											</div>

											<div class="field">
												<label>mimgName</label> <input value="${c.mimg }"
													name="mimg" type="text">
											</div>
											<div class="field">
												<label>time</label> <input name="time" value="${c.time }"
													type="text">
											</div>
