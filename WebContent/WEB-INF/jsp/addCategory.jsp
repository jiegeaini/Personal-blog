							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="https://maguangjie.com/addCategory"
											...
											<div class="two fields">
												...
												<div class="field">
													<label>desc_name</label> <input placeholder="desc"
														name="desc_name" type="text">
												</div>
											</div>
											<div class="inline fields">
												<label for="fruit">是否用cimg：</label>
												<div class="field">
											...
											<div class="field">
												<label>cimgName</label> <input name="cimg" type="text">
											</div>
											<div class="field">
												<label>mimgName</label> <input name="mimg" type="text">
											</div>
											<div class="field">
												<label>time</label> <input name="time" type="text">
											</div>
