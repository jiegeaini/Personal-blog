							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="https://maguangjie.com/updateContent"
											class="ui form segment form4" method="post"
											enctype="multipart/form-data">
											<input name="id" value="${c.id }" type="hidden" />
											<div class="two fields">
												<div class="field">
													<label>Name</label> <input placeholder="First Name"
														value="${c.name }" name="name" type="text">
												</div>

												<div class="field">
													<label>Category</label>
													<div class="ui selection dropdown" tabindex="0">
														<input value="${c.classMasterId }" name="classMasterId"
															type="hidden">
														<div class="default text">html</div>
														<i class="dropdown icon"></i>
														<div class="menu" tabindex="-1">
															<c:forEach items="${cate}" var="ca">
																<div class="item" data-value="${ca.id }">${ca.name }</div>
															</c:forEach>
											...
											<div class="field">
												<label>img</label> <input name="file_img" type="file">
											</div>
											<div class="field">
												<label>imgName</label> <input name="imgSrc"
													value="${c.imgSrc }" type="text">
											</div>
											<div class="field">
												<label>ContentUrl</label> <input name="url"
													value="${c.url }" type="text">
											</div>

											<div class="field">
												<label>cimg-name</label> <input name="cimg"
													value="${c.cimg }" type="text">
											</div>
