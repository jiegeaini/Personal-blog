							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="http://localhost/wxdemo/addDownload"
											...
											<div class="two field">
												...
												<div class="field">
													<label>downloadName</label> <input
														placeholder="downloadName" name="downloadName" type="text">
												</div>
											</div>
											<div class="field">
											...
											<div class="two field">
												...
												<label>img</label> <input name="file_img" accept="image/*"
													...
													<div class="field">
												<label>project</label> <input name="file_file" type="file">
													</div>
											</div>

											<div class="field">
												<label>imgName</label> <input name="img" type="text">
											</div>
