							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="https://maguangjie.com/updateDownload"
											method="post" class="ui form segment "
											enctype="multipart/form-data">
											<input value="${c.id }" name="id" type="hidden">
											<div class="two fields">
												<div class="field">
													<label>Name</label> <input placeholder="Name" name="name"
														value="${c.name }" type="text">
												</div>
												<div class="field">
													<label>category</label> <input placeholder="category"
														name="category" value="${c.category }" type="text">
												</div>
											</div>
											<div class="two field">
												<div class="field">
													<label>content</label> <input placeholder="content"
														name="content" value="${c.content }" type="text">
												</div>
												<div class="field">
													<label>downloadName</label> <input
														placeholder="downloadName" name="downloadName"
														value="${c.downloadName }" type="text">
												</div>
											</div>
											<div class="field">
												<label>url</label> <input placeholder="url" name="url"
													value="${c.url }" type="text">
											</div>
											...
											<div class="inline fields">
												...
												<div class="field">
													<div class="ui radio checkbox">
														<input type="radio" value="yes" name="booleanImg"
															tabindex="0" class="hidden"> <label>yes</label>
													</div>
												</div>
												<div class="field">
													<div class="ui radio checkbox">
											...
											<div class="field">
												<label>img</label> <input name="file_img" accept="image/*"
													type="file">
											</div>

											<div class="field">
												<label>imgName</label> <input name="img" value="${c.img }"
													type="text">
											</div>

											<div class="field">
												<label>time</label> <input value="${c.time }" name="time"
													type="text">
											</div>
