...
<link href="../css/main.css?a=2" rel="stylesheet" />
...
<body>
	<div id="contextWrap">
		...
		<div
			...
			data-color="grey">
			<a class="item logo" href="index.html"> <img src="../img/logo.jpg"
				alt="stagblogo" /><img src="../img/tou.jpg" alt="stagblogo"
				class="displaynone" />
			</a>
			<div class="ui accordion inverted">
				...
				<div class="content">
					<a class="item" href="getIndex"> 文章 </a> <a class="item"
						href="getAddPage"> 文章增加 </a> <a class="item"
						href="getCategory"> 文章分类 </a> <a class="item"
						href="getAddCategory"> 分类增加 </a>
				</div>
				<div class="title item">
					<i class="dropdown icon"></i> 问题管理
				</div>
				<div class="content">
					<a class="item" href="getQuestion"> 问题 </a> <a
						class="item" href="getAddQuestion"> 问题增加 </a> <a
						class="item" href="getMessage"> 问题信息 </a> <a
						class="item" href="getAddMessage"> 问题信息增加 </a>
				</div>
				...
				<div class="content">
					<a class="item" href="getExperience"> 经验 </a> <a
						class="item" href="getAddExperience"> 经验增加 </a> <a
						class="item" href="getExperienceMess"> 经验信息 </a> <a
						class="item" href="getAddExperienceMess"> 经验信息增加 </a>
				</div>
				...
				<div class="content">
					<a class="item" href="getComment">
						留言</a>
					<a class="item" href="getUploadImg">
						图片上传</a>
				</div>
		...
		<div class="title item">
				...
				<div class="content">
					<a class="item" href="getDownload">
						项目</a>
					<a class="item" href="getAddDownload">
						项目增加</a>
				</div>
			</div>
					...
					<div class="right menu colhidden">
						...
						<div class="ui dropdown item">
							<img class="ui mini circular image"
								src="../img/tou.jpg" alt="label-image" />
							<div class="menu">
								<a class="item" href="https://maguangjie.com/outLogin">Sign Out</a>
							</div>
						</div>
					</div>
				</div>
										...
										<tbody>
											<c:forEach items="${content }" var="c">
												<tr>
													...
													<td>${c.name }</td>
													<td>${c.imgSrc }</td>
													<td>${fn:substring(c.url, 0, 5)}</td>
													<td>${c.classMasterId }</td>
													<td>${fn:substring(c.cimg, 0, 5)}</td>
													<td>
													<a href="getupdateContentPage?id=${c.id }">
													<i class="write large icon"></i>
													</a > 
													<a href="https://maguangjie.com/deleteContent?id=${c.id }">
