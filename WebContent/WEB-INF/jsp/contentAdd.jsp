							...
							<div class="ui segments">
								...
								<div class="ui segment">
									...
									<div class="row">
										...
										<form action="https://maguangjie.com/addContent" method="post"
											class="ui form segment " enctype="multipart/form-data">
											<div class="two fields">
												...
												<div class="field">
													...
													<div class="ui selection dropdown" tabindex="0">
														<input name="classMasterId" type="hidden">
											...
											<div class="field">
												<label>imgName</label> <input name="imgSrc" type="text">
											</div>
											<div class="field">
												<label>ContentUrl</label> <input name="url" type="text">
											</div>

											<div class="field">
												<label>cimg-name</label> <input name="cimg" type="text">
											</div>
